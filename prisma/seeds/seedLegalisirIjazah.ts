  ...
  if (countLegalisirIjazah === 0) {
    ...
    await prisma.legalisirIjazah.create({
      data: {
        ...
        buktiPembayaran: `https://example.com/bukti_pembayaran_2105107010057_${new Date()
          .toISOString()
          .replace(/[-:T]/g, "")
          .slice(0, 14)}.pdf`,
        buktiIjazah: `https://example.com/bukti_ijazah_2105107010057_${new Date()
          .toISOString()
          .replace(/[-:T]/g, "")
          .slice(0, 14)}.pdf`,
        buktiTranskrip: `https://example.com/bukti_transkrip_2105107010057_${new Date()
          .toISOString()
          .replace(/[-:T]/g, "")
          .slice(0, 14)}.pdf`,
